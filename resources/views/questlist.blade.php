...
<div class="container">
    <div class="row">
        <div class="col s12 m6 l3">
            <?=printByType(1, $areaCate, $areaById)?>
            <?=printByType(6, $areaCate, $areaById)?>
            <?=printByType(7, $areaCate, $areaById)?>
            <?=printByType(3, $areaCate, $areaById)?>
            <?=printByType(5, $areaCate, $areaById)?>
            <?=printByType(10, $areaCate, $areaById)?>
        </div>
        <div class="col s12 m6 l3">
            <?=printByType(4, $areaCate, $areaById)?>
            <?=printByType(2, $areaCate, $areaById)?>
        </div>
        <div class="col s12 m6 l3">
            <?=printByType(9, $areaCate, $areaById)?>
        </div>
        <div class="col s12 m6 l3">
            <?=printByType(8, $areaCate, $areaById)?>
        </div>
    </div>
</div>
@stop
